...
#define configTOTAL_HEAP_SIZE                     (7500) /* size of heap in bytes */
...
/*----------------------------------------------------------*/
#define configMAX_TASK_NAME_LEN                   1 /* task name length in bytes */
...
#define configMAX_PRIORITIES                      1 /* task priorities can be from 0 up to this value-1 */
