...
const signed char *pcRegisteredCommandString;
        ...
        if( ( pxCommand != NULL ) && ( xReturn == pdFALSE ) )
        {
                ...
                was incorrect. */
                (void)strncpy( ( char * ) pcWriteBuffer, "Incorrect command parameter(s).  Enter \"help\" to view a list of available commands.\r\n\r\n", xWriteBufferLen );
                pxCommand = NULL;
        }
        ...
        else
        {
                ...
                (void)strncpy( ( char * ) pcWriteBuffer, ( const char * const ) "Command not recognised.  Enter \"help\" to view a list of available commands.\r\n\r\n", xWriteBufferLen );
                xReturn = pdFALSE;
        }
...
signed portBASE_TYPE xReturn;
        ...
        (void)strncpy( ( char * ) pcWriteBuffer, ( const char * ) pxCommand->pxCommandLineDefinition->pcHelpString, xWriteBufferLen );
