...
#define STRING_SUCCES()		(CLS1_SendStr((unsigned char*)"success", CLS1_GetStdio()->stdOut))
#define STRING_FAILURE()	(CLS1_SendStr((unsigned char*)"failure", CLS1_GetStdio()->stdOut))
